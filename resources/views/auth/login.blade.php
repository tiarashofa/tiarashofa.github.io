            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <input id="username" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="username" value="{{ old('username') }}" required autofocus />
                    </div>
