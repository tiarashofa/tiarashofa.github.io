...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($product->image): ?>
                                <div class="mb-2">
                                    <img src="<?php echo e(asset($product->image)); ?>" alt="<?php echo e($product->name); ?>" class="img-thumbnail" style="max-height: 200px">
                                </div>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\tiara-glow\resources\views/products/edit.blade.php ENDPATH**/ ?>