...
<body class="bg-gradient-to-br from-pink-50 to-indigo-100 min-h-screen">
    <div class="max-w-6xl mx-auto py-10">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('customers.create')); ?>" class="px-5 py-2 brand-gradient text-white rounded shadow hover:scale-105 transition flex items-center font-semibold"><i class="fa fa-plus mr-2"></i>Tambah Customer</a>
        </div>
            ...
            <table class="min-w-full divide-y divide-indigo-200">
                ...
                <tbody class="bg-white divide-y divide-indigo-100">
                    ...
                    <tr class="hover:bg-pink-50 transition">
                        <td class="px-4 py-3 font-mono text-sm"><?php echo e($customer->id); ?></td>
                        <td class="px-4 py-3 font-semibold text-indigo-800"><?php echo e($customer->name); ?></td>
                        <td class="px-4 py-3"><?php echo e($customer->email); ?></td>
                        <td class="px-4 py-3"><?php echo e($customer->phone); ?></td>
                        <td class="px-4 py-3"><?php echo e(Str::limit($customer->address, 50)); ?></td>
                        <td class="px-4 py-3 space-x-2">
                            <a href="<?php echo e(route('customers.show', $customer)); ?>" class="inline-block px-3 py-1 bg-blue-500 text-white rounded shadow hover:bg-blue-600 text-xs font-semibold"><i class="fa fa-eye"></i> Lihat</a>
                            <a href="<?php echo e(route('customers.edit', $customer)); ?>" class="inline-block px-3 py-1 bg-yellow-400 text-white rounded shadow hover:bg-yellow-500 text-xs font-semibold"><i class="fa fa-edit"></i> Edit</a>
...
</html> <?php /**PATH C:\Users\LENOVO\tiara-glow\resources\views/customers/index.blade.php ENDPATH**/ ?>